# -*- coding: utf-8 -*-
"""校验 ThousandPics_千机锦图.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千机锦图配置表|ThousandPic'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ThousandPics_千机锦图.xlsx")
    parser.add_argument("path", help="ThousandPics_千机锦图.xlsx 路径")
