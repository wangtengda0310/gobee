# -*- coding: utf-8 -*-
"""校验 RougeEndlessXinWu_千里单骑无尽信物表.xlsx：通用结构化规则（表结构 A，主键 XinWuId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽信物表|RougeEndlessXinWu'
PK_FIELD = 'XinWuId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessXinWu_千里单骑无尽信物表.xlsx")
    parser.add_argument("path", help="RougeEndlessXinWu_千里单骑无尽信物表.xlsx 路径")
