# -*- coding: utf-8 -*-
"""校验 PetEasterEggIdle_灵宠彩蛋待机.xlsx：通用结构化规则（表结构 A，主键 PetItemId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '灵宠彩蛋待机|PetEasterEggIdle'
PK_FIELD = 'PetItemId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PetEasterEggIdle_灵宠彩蛋待机.xlsx")
    parser.add_argument("path", help="PetEasterEggIdle_灵宠彩蛋待机.xlsx 路径")
