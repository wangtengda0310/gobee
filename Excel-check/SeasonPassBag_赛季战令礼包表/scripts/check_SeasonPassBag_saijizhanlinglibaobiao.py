# -*- coding: utf-8 -*-
"""校验 SeasonPassBag_赛季战令礼包表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '战令礼包表|SeasonPassBag'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SeasonPassBag_赛季战令礼包表.xlsx")
    parser.add_argument("path", help="SeasonPassBag_赛季战令礼包表.xlsx 路径")
