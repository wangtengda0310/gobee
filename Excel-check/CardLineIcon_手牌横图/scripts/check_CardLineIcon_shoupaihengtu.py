# -*- coding: utf-8 -*-
"""校验 CardLineIcon_手牌横图.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 CardLineIcon_手牌横图.xlsx")
    parser.add_argument("path", help="CardLineIcon_手牌横图.xlsx 路径")
