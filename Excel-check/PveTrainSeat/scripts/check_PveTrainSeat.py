# -*- coding: utf-8 -*-
"""校验 PveTrainSeat.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveTrainSeat.xlsx")
    parser.add_argument("path", help="PveTrainSeat.xlsx 路径")
