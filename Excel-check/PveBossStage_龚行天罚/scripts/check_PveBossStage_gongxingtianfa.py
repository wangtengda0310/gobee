# -*- coding: utf-8 -*-
"""校验 PveBossStage_龚行天罚.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveBossStage_龚行天罚.xlsx")
    parser.add_argument("path", help="PveBossStage_龚行天罚.xlsx 路径")
