# -*- coding: utf-8 -*-
"""校验 TongPao_同袍共战.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '同袍共战活动表|ActivityTongPao'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 TongPao_同袍共战.xlsx")
    parser.add_argument("path", help="TongPao_同袍共战.xlsx 路径")
