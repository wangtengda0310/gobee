# -*- coding: utf-8 -*-
"""校验 TitleByRank_排行称号表.xlsx：通用结构化规则（表结构 A，主键 Id）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 TitleByRank_排行称号表.xlsx")
    parser.add_argument("path", help="TitleByRank_排行称号表.xlsx 路径")
