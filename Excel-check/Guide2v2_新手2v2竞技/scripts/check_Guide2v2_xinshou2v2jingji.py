# -*- coding: utf-8 -*-
"""校验 Guide2v2_新手2v2竞技.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Guide2v2_新手2v2竞技.xlsx")
    parser.add_argument("path", help="Guide2v2_新手2v2竞技.xlsx 路径")
