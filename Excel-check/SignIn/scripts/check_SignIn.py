...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SignIn.xlsx")
    parser.add_argument("path", help="SignIn.xlsx 路径")
