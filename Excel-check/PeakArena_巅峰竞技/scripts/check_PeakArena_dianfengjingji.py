# -*- coding: utf-8 -*-
"""校验 PeakArena_巅峰竞技.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PeakArena_巅峰竞技.xlsx")
    parser.add_argument("path", help="PeakArena_巅峰竞技.xlsx 路径")
