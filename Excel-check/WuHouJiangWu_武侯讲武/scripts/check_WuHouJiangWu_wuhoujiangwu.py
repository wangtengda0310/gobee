# -*- coding: utf-8 -*-
"""校验 WuHouJiangWu_武侯讲武.xlsx：通用结构化规则（表结构 A，主键 whjwType）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 WuHouJiangWu_武侯讲武.xlsx")
    parser.add_argument("path", help="WuHouJiangWu_武侯讲武.xlsx 路径")
