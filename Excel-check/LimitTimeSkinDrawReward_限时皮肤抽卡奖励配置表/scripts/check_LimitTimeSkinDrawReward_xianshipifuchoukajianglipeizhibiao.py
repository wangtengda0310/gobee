# -*- coding: utf-8 -*-
"""校验 LimitTimeSkinDrawReward_限时皮肤抽卡奖励配置表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '限时皮肤次数奖|LimitSkinTimesReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 LimitTimeSkinDrawReward_限时皮肤抽卡奖励配置表.xlsx")
    parser.add_argument("path", help="LimitTimeSkinDrawReward_限时皮肤抽卡奖励配置表.xlsx 路径")
