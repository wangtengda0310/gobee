# -*- coding: utf-8 -*-
"""校验 HeroRetreat_武将归隐表.xlsx：通用结构化规则（表结构 A，主键 PlayMode）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroRetreat_武将归隐表.xlsx")
    parser.add_argument("path", help="HeroRetreat_武将归隐表.xlsx 路径")
