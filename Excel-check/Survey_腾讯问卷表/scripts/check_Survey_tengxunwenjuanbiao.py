# -*- coding: utf-8 -*-
"""校验 Survey_腾讯问卷表.xlsx：通用结构化规则（表结构 A，主键 SurveyId）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Survey_腾讯问卷表.xlsx")
    parser.add_argument("path", help="Survey_腾讯问卷表.xlsx 路径")
