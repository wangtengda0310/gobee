# -*- coding: utf-8 -*-
"""校验 NewbieChallenge_新手挑战v2.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 NewbieChallenge_新手挑战v2.xlsx")
    parser.add_argument("path", help="NewbieChallenge_新手挑战v2.xlsx 路径")
