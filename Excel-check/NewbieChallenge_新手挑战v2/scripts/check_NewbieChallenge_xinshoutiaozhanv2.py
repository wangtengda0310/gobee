# -*- coding: utf-8 -*-
"""校验 NewbieChallenge_新手挑战v2.xlsx（表结构 A，主键 Id）。"""
...
PK_FIELD = 'Id'
L1_FIELDS = ['ChallengeText', 'ChallengeTaskText', 'LeftTopTipText', 'BubbleTipText', 'ChallengeDescriptionHint']
DISPLAY_FIELD = 'ChallengeText'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
