# -*- coding: utf-8 -*-
"""校验 SkillEnchant_技能强化.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SkillEnchant_技能强化.xlsx")
    parser.add_argument("path", help="SkillEnchant_技能强化.xlsx 路径")
