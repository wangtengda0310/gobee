# -*- coding: utf-8 -*-
"""校验 UI文本配置表.xlsx：通用结构化规则（表结构 A，主键 key）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 UI文本配置表.xlsx")
    parser.add_argument("path", help="UI文本配置表.xlsx 路径")
