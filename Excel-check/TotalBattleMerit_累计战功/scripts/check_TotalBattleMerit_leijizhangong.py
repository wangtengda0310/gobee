# -*- coding: utf-8 -*-
"""校验 TotalBattleMerit_累计战功.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '累计战功表|TotalBattleMerit'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 TotalBattleMerit_累计战功.xlsx")
    parser.add_argument("path", help="TotalBattleMerit_累计战功.xlsx 路径")
