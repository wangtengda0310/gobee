# -*- coding: utf-8 -*-
"""校验 RechargeChannel_充值渠道映射表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '充值渠道映射表|RechargeChannel'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RechargeChannel_充值渠道映射表.xlsx")
    parser.add_argument("path", help="RechargeChannel_充值渠道映射表.xlsx 路径")
