# -*- coding: utf-8 -*-
"""校验 TaskCompleteCond.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '任务完成条件表|TaskCompleteConditon'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 TaskCompleteCond.xlsx")
    parser.add_argument("path", help="TaskCompleteCond.xlsx 路径")
