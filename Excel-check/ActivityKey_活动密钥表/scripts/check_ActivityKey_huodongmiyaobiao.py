# -*- coding: utf-8 -*-
"""校验 ActivityKey_活动密钥表.xlsx：通用结构化规则（表结构 A，主键 ActivityId）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ActivityKey_活动密钥表.xlsx")
    parser.add_argument("path", help="ActivityKey_活动密钥表.xlsx 路径")
