# -*- coding: utf-8 -*-
"""校验 CardSkin_手牌皮肤表.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 CardSkin_手牌皮肤表.xlsx")
    parser.add_argument("path", help="CardSkin_手牌皮肤表.xlsx 路径")
