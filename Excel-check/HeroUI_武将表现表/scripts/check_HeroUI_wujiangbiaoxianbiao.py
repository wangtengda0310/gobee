# -*- coding: utf-8 -*-
"""校验 HeroUI_武将表现表.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroUI_武将表现表.xlsx")
    parser.add_argument("path", help="HeroUI_武将表现表.xlsx 路径")
