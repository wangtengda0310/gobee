# -*- coding: utf-8 -*-
"""校验 GiftLimitShop_限时礼包商品.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '限时礼包商品|GiftLimitGood'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GiftLimitShop_限时礼包商品.xlsx")
    parser.add_argument("path", help="GiftLimitShop_限时礼包商品.xlsx 路径")
