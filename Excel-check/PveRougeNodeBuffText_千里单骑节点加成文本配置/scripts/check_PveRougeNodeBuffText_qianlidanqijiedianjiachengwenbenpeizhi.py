# -*- coding: utf-8 -*-
"""校验 PveRougeNodeBuffText_千里单骑节点加成文本配置.xlsx：通用结构化规则（表结构 A，主键 BuffType）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑加成文本配置|PveRougeNodeBuffText'
PK_FIELD = 'BuffType'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeNodeBuffText_千里单骑节点加成文本配置.xlsx")
    parser.add_argument("path", help="PveRougeNodeBuffText_千里单骑节点加成文本配置.xlsx 路径")
