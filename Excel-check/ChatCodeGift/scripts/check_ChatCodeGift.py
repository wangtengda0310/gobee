# -*- coding: utf-8 -*-
"""校验 ChatCodeGift.xlsx：通用结构化规则（首轮自动生成）。"""
...
ID_TYPE = 'mixed'  # int | string | mixed
DISPLAY_FIELD = 'Name'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ChatCodeGift.xlsx")
    parser.add_argument("path", help="ChatCodeGift.xlsx 路径")
