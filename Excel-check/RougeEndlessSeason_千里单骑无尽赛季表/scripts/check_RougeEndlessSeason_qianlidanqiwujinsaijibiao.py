# -*- coding: utf-8 -*-
"""校验 RougeEndlessSeason_千里单骑无尽赛季表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽赛季表|RougeEndlessSeason'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessSeason_千里单骑无尽赛季表.xlsx")
    parser.add_argument("path", help="RougeEndlessSeason_千里单骑无尽赛季表.xlsx 路径")
