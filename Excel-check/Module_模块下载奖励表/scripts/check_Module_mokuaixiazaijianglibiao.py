# -*- coding: utf-8 -*-
"""校验 Module_模块下载奖励表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '模块奖励配置表|ModuleAward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Module_模块下载奖励表.xlsx")
    parser.add_argument("path", help="Module_模块下载奖励表.xlsx 路径")
