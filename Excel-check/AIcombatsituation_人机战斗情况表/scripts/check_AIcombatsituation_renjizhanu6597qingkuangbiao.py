# -*- coding: utf-8 -*-
"""校验 AIcombatsituation_人机战斗情况表.xlsx：通用结构化规则（表结构 A，主键 SituationID）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '人机战斗情况表|AICombatSituation'
PK_FIELD = 'SituationID'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 AIcombatsituation_人机战斗情况表.xlsx")
    parser.add_argument("path", help="AIcombatsituation_人机战斗情况表.xlsx 路径")
