# -*- coding: utf-8 -*-
"""校验 PartnerTrainSeat.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '座位配置表|PartnerTrainSeat'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PartnerTrainSeat.xlsx")
    parser.add_argument("path", help="PartnerTrainSeat.xlsx 路径")
