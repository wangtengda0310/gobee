# -*- coding: utf-8 -*-
"""校验 GiftShop_礼包商店.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GiftShop_礼包商店.xlsx")
    parser.add_argument("path", help="GiftShop_礼包商店.xlsx 路径")
