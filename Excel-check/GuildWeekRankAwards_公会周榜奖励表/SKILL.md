...
python "GuildWeekRankAwards_公会周榜奖励表/scripts/check_GuildWeekRankAwards_gonghuizhoubangjianglibiao.py" "<路径>" --semantic-json
```

Issue：`CountryRank=<CountryRank> | CountryRank=… | <字段> | <说明>`
