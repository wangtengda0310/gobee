# -*- coding: utf-8 -*-
"""校验 GuildWeekRankAwards_公会周榜奖励表.xlsx：通用结构化规则（表结构 A，主键 CountryRank）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '公会周榜奖励表|GuildWeekRankAward'
PK_FIELD = 'CountryRank'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GuildWeekRankAwards_公会周榜奖励表.xlsx")
    parser.add_argument("path", help="GuildWeekRankAwards_公会周榜奖励表.xlsx 路径")
