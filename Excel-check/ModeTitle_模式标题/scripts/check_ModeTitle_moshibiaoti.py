# -*- coding: utf-8 -*-
"""校验 ModeTitle_模式标题.xlsx（表结构 A，主键 SysId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '模式标题|ModeTitle'
PK_FIELD = 'SysId'
L1_FIELDS = ['TitleName', 'HasRuleDes', 'RuleTitle', 'RuleSimpleContent', 'RuleDetailContent']
DISPLAY_FIELD = 'TitleName'
ID_TYPE = 'string'
STRUCT_KIND = 'A'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ModeTitle_模式标题.xlsx")
