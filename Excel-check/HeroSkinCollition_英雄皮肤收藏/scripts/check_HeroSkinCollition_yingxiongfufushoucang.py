# -*- coding: utf-8 -*-
"""校验 HeroSkinCollition_英雄皮肤收藏.xlsx：通用结构化规则（表结构 A，主键 Type）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '英雄皮肤收藏|HeroSkinCollition'
PK_FIELD = 'Type'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroSkinCollition_英雄皮肤收藏.xlsx")
    parser.add_argument("path", help="HeroSkinCollition_英雄皮肤收藏.xlsx 路径")
