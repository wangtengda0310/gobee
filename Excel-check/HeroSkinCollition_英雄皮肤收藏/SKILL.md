...
```bash
python "HeroSkinCollition_英雄皮肤收藏/scripts/check_HeroSkinCollition_yingxiongfufushoucang.py" "<路径>"
python "HeroSkinCollition_英雄皮肤收藏/scripts/check_HeroSkinCollition_yingxiongfufushoucang.py" "<路径>" --json
```

Issue：`Type=<Type> | Name=<Name> | <字段> | <说明>`
