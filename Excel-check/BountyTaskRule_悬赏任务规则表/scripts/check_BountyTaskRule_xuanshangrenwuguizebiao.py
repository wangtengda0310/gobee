# -*- coding: utf-8 -*-
"""校验 BountyTaskRule_悬赏任务规则表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '悬赏任务规则表|BountyTaskRule'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 BountyTaskRule_悬赏任务规则表.xlsx")
    parser.add_argument("path", help="BountyTaskRule_悬赏任务规则表.xlsx 路径")
