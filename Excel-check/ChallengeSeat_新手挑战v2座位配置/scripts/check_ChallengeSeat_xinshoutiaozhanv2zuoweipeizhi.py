# -*- coding: utf-8 -*-
"""校验 ChallengeSeat_新手挑战v2座位配置.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '挑战座位表|ChallengeSeatGroup'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ChallengeSeat_新手挑战v2座位配置.xlsx")
    parser.add_argument("path", help="ChallengeSeat_新手挑战v2座位配置.xlsx 路径")
