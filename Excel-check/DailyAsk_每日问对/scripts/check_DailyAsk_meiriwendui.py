# -*- coding: utf-8 -*-
"""校验 DailyAsk_每日问对.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 DailyAsk_每日问对.xlsx")
    parser.add_argument("path", help="DailyAsk_每日问对.xlsx 路径")
