# -*- coding: utf-8 -*-
"""校验 ActivityLogin_登录活动表.xlsx：通用结构化规则（表结构 A，主键 ActivityId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '累计登录活动通用配置|ActivityLogin'
PK_FIELD = 'ActivityId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ActivityLogin_登录活动表.xlsx")
    parser.add_argument("path", help="ActivityLogin_登录活动表.xlsx 路径")
