# -*- coding: utf-8 -*-
"""校验 AudioBnk_音频配置bnk.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 AudioBnk_音频配置bnk.xlsx")
    parser.add_argument("path", help="AudioBnk_音频配置bnk.xlsx 路径")
