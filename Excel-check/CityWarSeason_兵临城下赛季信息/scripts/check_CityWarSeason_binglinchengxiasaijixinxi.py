# -*- coding: utf-8 -*-
"""校验 CityWarSeason_兵临城下赛季信息.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '兵临城下赛季信息|CityWarSeason'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 CityWarSeason_兵临城下赛季信息.xlsx")
    parser.add_argument("path", help="CityWarSeason_兵临城下赛季信息.xlsx 路径")
