# -*- coding: utf-8 -*-
"""校验 Achieve.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Achieve.xlsx")
    parser.add_argument("path", help="Achieve.xlsx 路径")
