# -*- coding: utf-8 -*-
"""校验 SecPwdRule_二级密码规则.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SecPwdRule_二级密码规则.xlsx")
    parser.add_argument("path", help="SecPwdRule_二级密码规则.xlsx 路径")
