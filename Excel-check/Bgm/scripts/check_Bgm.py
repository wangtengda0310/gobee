# -*- coding: utf-8 -*-
"""校验 Bgm.xlsx：通用结构化规则（表结构 A，主键 RandomBgmAudioId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = 'Bgm配置表|Bgm'
PK_FIELD = 'RandomBgmAudioId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Bgm.xlsx")
    parser.add_argument("path", help="Bgm.xlsx 路径")
