# -*- coding: utf-8 -*-
"""校验 DeviceLevel_设备分级表.xlsx：通用结构化规则（表结构 A，主键 PerfLevel）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = 'GPU型号判断|PerfLevelSetting'
PK_FIELD = 'PerfLevel'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 DeviceLevel_设备分级表.xlsx")
    parser.add_argument("path", help="DeviceLevel_设备分级表.xlsx 路径")
