# -*- coding: utf-8 -*-
"""校验 ItemTimeLimitResolve_道具限时分解表.xlsx：通用结构化规则（表结构 A，主键 Id）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 3
SHEET_NAME = '道具限时分解表|ItemTimeLimitResolve'
PK_FIELD = 'Id'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ItemTimeLimitResolve_道具限时分解表.xlsx")
    parser.add_argument("path", help="ItemTimeLimitResolve_道具限时分解表.xlsx 路径")
