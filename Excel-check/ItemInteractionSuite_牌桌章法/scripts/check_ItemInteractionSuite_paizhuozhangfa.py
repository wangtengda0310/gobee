# -*- coding: utf-8 -*-
"""校验 ItemInteractionSuite_牌桌章法.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '牌桌章法|ItemInteractionSuite'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ItemInteractionSuite_牌桌章法.xlsx")
    parser.add_argument("path", help="ItemInteractionSuite_牌桌章法.xlsx 路径")
