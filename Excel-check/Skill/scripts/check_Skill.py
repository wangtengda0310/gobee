...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Skill.xlsx")
    parser.add_argument("path", help="Skill.xlsx 路径")
