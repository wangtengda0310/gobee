# -*- coding: utf-8 -*-
"""校验 RougeEndlessKaKaNode_千里单骑无尽卡卡节点表.xlsx：通用结构化规则（表结构 A，主键 KaKaId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽卡卡表|RougeEndlessKaKaNode'
PK_FIELD = 'KaKaId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessKaKaNode_千里单骑无尽卡卡节点表.xlsx")
    parser.add_argument("path", help="RougeEndlessKaKaNode_千里单骑无尽卡卡节点表.xlsx 路径")
