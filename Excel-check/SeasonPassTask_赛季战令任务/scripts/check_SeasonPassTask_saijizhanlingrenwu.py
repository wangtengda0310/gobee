# -*- coding: utf-8 -*-
"""校验 SeasonPassTask_赛季战令任务.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 5
SHEET_NAME = '战令任务表|SeasonPassTask'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SeasonPassTask_赛季战令任务.xlsx")
    parser.add_argument("path", help="SeasonPassTask_赛季战令任务.xlsx 路径")
