# -*- coding: utf-8 -*-
"""校验 IdentityEncodeRule_身份编码规则表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '身份编码规则|IdentityEncodeRule'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 IdentityEncodeRule_身份编码规则表.xlsx")
    parser.add_argument("path", help="IdentityEncodeRule_身份编码规则表.xlsx 路径")
