# -*- coding: utf-8 -*-
"""校验 YiBiQianJin_一笔千金.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 YiBiQianJin_一笔千金.xlsx")
    parser.add_argument("path", help="YiBiQianJin_一笔千金.xlsx 路径")
