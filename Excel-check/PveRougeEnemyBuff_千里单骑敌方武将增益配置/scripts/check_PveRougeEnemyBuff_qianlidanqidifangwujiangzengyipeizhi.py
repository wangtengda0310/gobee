# -*- coding: utf-8 -*-
"""校验 PveRougeEnemyBuff_千里单骑敌方武将增益配置.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑敌方武将增益|PveRougeEnemyBuff'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeEnemyBuff_千里单骑敌方武将增益配置.xlsx")
    parser.add_argument("path", help="PveRougeEnemyBuff_千里单骑敌方武将增益配置.xlsx 路径")
