# -*- coding: utf-8 -*-
"""校验 RougeEndlessSanLeiNode_千里单骑无尽三类节点表.xlsx：通用结构化规则（表结构 A，主键 SanLeiId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽三类表|RougeEndlessSanLeiNode'
PK_FIELD = 'SanLeiId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessSanLeiNode_千里单骑无尽三类节点表.xlsx")
    parser.add_argument("path", help="RougeEndlessSanLeiNode_千里单骑无尽三类节点表.xlsx 路径")
