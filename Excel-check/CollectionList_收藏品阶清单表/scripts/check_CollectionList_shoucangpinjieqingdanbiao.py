# -*- coding: utf-8 -*-
"""校验 CollectionList_收藏品阶清单表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '收藏品阶清单表|CollectionList'
...
ID_TYPE = 'string'  # int | string | mixed
DISPLAY_FIELD = 'Name'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 CollectionList_收藏品阶清单表.xlsx")
    parser.add_argument("path", help="CollectionList_收藏品阶清单表.xlsx 路径")
