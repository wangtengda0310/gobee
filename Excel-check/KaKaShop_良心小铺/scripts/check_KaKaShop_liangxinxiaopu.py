# -*- coding: utf-8 -*-
"""校验 KaKaShop_良心小铺.xlsx：通用结构化规则（表结构 A，主键 goodId）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 KaKaShop_良心小铺.xlsx")
    parser.add_argument("path", help="KaKaShop_良心小铺.xlsx 路径")
