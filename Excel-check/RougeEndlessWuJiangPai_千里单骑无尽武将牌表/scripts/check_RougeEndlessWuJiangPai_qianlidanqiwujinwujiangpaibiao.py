# -*- coding: utf-8 -*-
"""校验 RougeEndlessWuJiangPai_千里单骑无尽武将牌表.xlsx：通用结构化规则（表结构 A，主键 HeroCardId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽武将牌表|RougeEndlessWuJiangPai'
PK_FIELD = 'HeroCardId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessWuJiangPai_千里单骑无尽武将牌表.xlsx")
    parser.add_argument("path", help="RougeEndlessWuJiangPai_千里单骑无尽武将牌表.xlsx 路径")
