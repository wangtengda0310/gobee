# -*- coding: utf-8 -*-
"""校验 PveNewbieChallenge_新手挑战.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '新手挑战表|PveNewbieChallenge'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveNewbieChallenge_新手挑战.xlsx")
    parser.add_argument("path", help="PveNewbieChallenge_新手挑战.xlsx 路径")
