# -*- coding: utf-8 -*-
"""校验 GuildCityWeekRankAwards_山河周榜奖励表.xlsx：通用结构化规则（表结构 A，主键 Rank）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '山河周榜奖励表|GuildCityWeekRankAward'
PK_FIELD = 'Rank'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GuildCityWeekRankAwards_山河周榜奖励表.xlsx")
    parser.add_argument("path", help="GuildCityWeekRankAwards_山河周榜奖励表.xlsx 路径")
