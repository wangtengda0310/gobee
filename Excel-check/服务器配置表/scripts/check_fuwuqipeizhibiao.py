...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 服务器配置表.xlsx")
    parser.add_argument("path", help="服务器配置表.xlsx 路径")
