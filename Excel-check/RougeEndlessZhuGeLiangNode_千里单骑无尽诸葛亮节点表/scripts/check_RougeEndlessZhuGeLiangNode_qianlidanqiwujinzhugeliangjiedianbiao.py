# -*- coding: utf-8 -*-
"""校验 RougeEndlessZhuGeLiangNode_千里单骑无尽诸葛亮节点表.xlsx：通用结构化规则（表结构 A，主键 ZhuGeLiangId）。"""
...
def main() -> int:
    ...
    parser.add_argument("path", help="RougeEndlessZhuGeLiangNode_千里单骑无尽诸葛亮节点表.xlsx 路径")
