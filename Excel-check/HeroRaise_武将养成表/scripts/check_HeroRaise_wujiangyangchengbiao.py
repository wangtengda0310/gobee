# -*- coding: utf-8 -*-
"""校验 HeroRaise_武将养成表.xlsx（表结构 A，主键 Id）。"""
...
PK_FIELD = 'Id'
L1_FIELDS = ['HeroRaiseLevelName', 'BattleAdvTitle', 'BattleAdvContent', 'BattleShowContent', 'LevelNamePrefix']
DISPLAY_FIELD = 'HeroRaiseLevelName'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
