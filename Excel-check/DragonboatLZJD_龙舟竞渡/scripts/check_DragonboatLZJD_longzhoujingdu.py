# -*- coding: utf-8 -*-
"""校验 DragonboatLZJD_龙舟竞渡.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '龙舟竞渡|DragonboatLZJD'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 DragonboatLZJD_龙舟竞渡.xlsx")
    parser.add_argument("path", help="DragonboatLZJD_龙舟竞渡.xlsx 路径")
