# -*- coding: utf-8 -*-
"""校验 PackageSignature_包签名.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '包签名表|PackageSignature'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PackageSignature_包签名.xlsx")
    parser.add_argument("path", help="PackageSignature_包签名.xlsx 路径")
