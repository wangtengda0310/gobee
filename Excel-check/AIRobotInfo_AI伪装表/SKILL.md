...
主要字段：`Id`, `AIName`, `Level`, `TodayGetExp`, `Exp`, `Country`, `Sex`, `ImageItemId`, `Prestige`, `DunScore`, `ChuJunWinCount`, `ChuJunTotalCount`, `ChuJunEscapeCount`, `HanJunWinCount`, `HanJunTotalCount`, `HanJunEscapeCount`, `ZhuGongWinCount`, `ZhuGongTotalCount`, `ZhuGongEscapeCount`, `XianZhuWinCount`, `XianZhuTotalCount`, `XianZhuEscapeCount`, `QianLongWinCount`, `QianLongTotalCount`, `QianLongEscapeCount` 等共 40 列
