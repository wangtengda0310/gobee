# -*- coding: utf-8 -*-
"""校验 SkillTag_技能标签表.xlsx：通用结构化规则（表结构 A，主键 SkillTag）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SkillTag_技能标签表.xlsx")
    parser.add_argument("path", help="SkillTag_技能标签表.xlsx 路径")
