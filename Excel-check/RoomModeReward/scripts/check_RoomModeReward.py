# -*- coding: utf-8 -*-
"""校验 RoomModeReward.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '模式方式|RoomModeReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RoomModeReward.xlsx")
    parser.add_argument("path", help="RoomModeReward.xlsx 路径")
