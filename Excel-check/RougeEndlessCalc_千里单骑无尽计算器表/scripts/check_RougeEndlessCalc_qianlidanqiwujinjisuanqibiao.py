# -*- coding: utf-8 -*-
"""校验 RougeEndlessCalc_千里单骑无尽计算器表.xlsx：通用结构化规则（表结构 A，主键 CalcId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽计算器表|RougeEndlessCalc'
PK_FIELD = 'CalcId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessCalc_千里单骑无尽计算器表.xlsx")
    parser.add_argument("path", help="RougeEndlessCalc_千里单骑无尽计算器表.xlsx 路径")
