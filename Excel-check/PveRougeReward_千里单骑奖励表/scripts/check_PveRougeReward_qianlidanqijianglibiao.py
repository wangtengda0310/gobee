# -*- coding: utf-8 -*-
"""校验 PveRougeReward_千里单骑奖励表.xlsx：通用结构化规则（表结构 A，主键 LayersId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里奖励表|PveRougeReward'
PK_FIELD = 'LayersId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeReward_千里单骑奖励表.xlsx")
    parser.add_argument("path", help="PveRougeReward_千里单骑奖励表.xlsx 路径")
