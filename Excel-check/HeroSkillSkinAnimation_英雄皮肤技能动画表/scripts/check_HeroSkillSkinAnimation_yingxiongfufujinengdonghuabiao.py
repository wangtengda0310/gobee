# -*- coding: utf-8 -*-
"""校验 HeroSkillSkinAnimation_英雄皮肤技能动画表.xlsx：通用结构化规则（表结构 A，主键 SkinItemId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '英雄皮肤技能动画|HeroSkillSkinAnimation'
PK_FIELD = 'SkinItemId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroSkillSkinAnimation_英雄皮肤技能动画表.xlsx")
    parser.add_argument("path", help="HeroSkillSkinAnimation_英雄皮肤技能动画表.xlsx 路径")
