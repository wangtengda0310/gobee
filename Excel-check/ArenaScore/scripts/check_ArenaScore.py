# -*- coding: utf-8 -*-
"""校验 ArenaScore.xlsx：通用结构化规则（表结构 A，主键 Dan）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ArenaScore.xlsx")
    parser.add_argument("path", help="ArenaScore.xlsx 路径")
