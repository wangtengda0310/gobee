# -*- coding: utf-8 -*-
"""校验 HeroSkillSkinFx_英雄皮肤技能特效.xlsx：通用结构化规则（表结构 A，主键 HeroId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '英雄技能皮肤|HeroSkillSkinFx'
PK_FIELD = 'HeroId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroSkillSkinFx_英雄皮肤技能特效.xlsx")
    parser.add_argument("path", help="HeroSkillSkinFx_英雄皮肤技能特效.xlsx 路径")
