# -*- coding: utf-8 -*-
"""校验 GuildCityCreate.xlsx：通用结构化规则（表结构 A，主键 Count）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '创建公会城池消耗表|GuildCityCreate'
PK_FIELD = 'Count'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GuildCityCreate.xlsx")
    parser.add_argument("path", help="GuildCityCreate.xlsx 路径")
