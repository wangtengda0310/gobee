# -*- coding: utf-8 -*-
"""校验 RougeEndlessRankReward_千里单骑无尽排行奖励表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '赛季里程排行奖励表|REStageRankReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessRankReward_千里单骑无尽排行奖励表.xlsx")
    parser.add_argument("path", help="RougeEndlessRankReward_千里单骑无尽排行奖励表.xlsx 路径")
