# -*- coding: utf-8 -*-
"""校验 RatePseudo_伪概率.xlsx：通用结构化规则（表结构 A，主键 RateID）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RatePseudo_伪概率.xlsx")
    parser.add_argument("path", help="RatePseudo_伪概率.xlsx 路径")
