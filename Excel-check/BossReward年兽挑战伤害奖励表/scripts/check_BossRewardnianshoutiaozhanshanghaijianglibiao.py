# -*- coding: utf-8 -*-
"""校验 BossReward年兽挑战伤害奖励表.xlsx：通用结构化规则（表结构 A，主键 DamageId）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 BossReward年兽挑战伤害奖励表.xlsx")
    parser.add_argument("path", help="BossReward年兽挑战伤害奖励表.xlsx 路径")
