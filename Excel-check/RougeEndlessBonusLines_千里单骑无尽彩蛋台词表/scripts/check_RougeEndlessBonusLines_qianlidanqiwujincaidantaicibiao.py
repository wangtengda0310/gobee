# -*- coding: utf-8 -*-
"""校验 RougeEndlessBonusLines_千里单骑无尽彩蛋台词表.xlsx：通用结构化规则（表结构 A，主键 UserHeroId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽彩蛋台词|RougeEndlessBonusLines'
PK_FIELD = 'UserHeroId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessBonusLines_千里单骑无尽彩蛋台词表.xlsx")
    parser.add_argument("path", help="RougeEndlessBonusLines_千里单骑无尽彩蛋台词表.xlsx 路径")
