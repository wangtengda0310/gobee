# -*- coding: utf-8 -*-
"""校验 PetRaise_灵宠养成表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 5
SHEET_NAME = '灵宠升级表|PetRaiseLevel'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PetRaise_灵宠养成表.xlsx")
    parser.add_argument("path", help="PetRaise_灵宠养成表.xlsx 路径")
