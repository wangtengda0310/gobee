# -*- coding: utf-8 -*-
"""校验 SkillCardSort.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SkillCardSort.xlsx")
    parser.add_argument("path", help="SkillCardSort.xlsx 路径")
