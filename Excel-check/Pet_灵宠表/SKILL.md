...
主要字段：`Id`, `Name`, `WuXingType`, `PrefabPath`, `StartTime`, `Skill`, `BattleAttrWeight`, `HighBattleAttr`, `UpgradeLikeItem`, `UpgradeHateItem`, `SquareHeadIcon`, `HeadIcon`, `Silhouette`, `PopBg`, `PopIcon`, `PopTitle`, `PetWeekTaskBg`, `Access`, `AccessParam`, `AccessDesc`, `InfoTextID`
