# -*- coding: utf-8 -*-
"""校验 GuildCityLevel.xlsx：通用结构化规则（表结构 A，主键 Level）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '公会城池等级表|GuildCityLevel'
PK_FIELD = 'Level'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GuildCityLevel.xlsx")
    parser.add_argument("path", help="GuildCityLevel.xlsx 路径")
