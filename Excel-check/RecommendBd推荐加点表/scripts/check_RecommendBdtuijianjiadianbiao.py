# -*- coding: utf-8 -*-
"""校验 RecommendBd推荐加点表.xlsx：通用结构化规则（表结构 A，主键 HeroId）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RecommendBd推荐加点表.xlsx")
    parser.add_argument("path", help="RecommendBd推荐加点表.xlsx 路径")
