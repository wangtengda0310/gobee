# -*- coding: utf-8 -*-
"""校验 Rank_排行榜配置.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Rank_排行榜配置.xlsx")
    parser.add_argument("path", help="Rank_排行榜配置.xlsx 路径")
