# -*- coding: utf-8 -*-
"""校验 RougeEndlessHeroBuff_千里单骑无尽武将加成对应表.xlsx：通用结构化规则（表结构 A，主键 HeroId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '武将加成对应表|RougeEndlessHeroBuff'
PK_FIELD = 'HeroId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessHeroBuff_千里单骑无尽武将加成对应表.xlsx")
    parser.add_argument("path", help="RougeEndlessHeroBuff_千里单骑无尽武将加成对应表.xlsx 路径")
