# -*- coding: utf-8 -*-
"""校验 DrawHJZP_黄金转盘.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 DrawHJZP_黄金转盘.xlsx")
    parser.add_argument("path", help="DrawHJZP_黄金转盘.xlsx 路径")
