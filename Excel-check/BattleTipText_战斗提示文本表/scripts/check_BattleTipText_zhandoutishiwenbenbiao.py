# -*- coding: utf-8 -*-
"""校验 BattleTipText_战斗提示文本表.xlsx（表结构 A，主键 key）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '战斗提示文本|BattleTipText'
PK_FIELD = 'key'
L1_FIELDS = ['Text0', 'Text1', 'Text2', 'Text3', 'Text4', 'Text5', 'Text6', 'Text7', 'Text8', 'Text9', 'Text10']
DISPLAY_FIELD = 'Text0'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 BattleTipText_战斗提示文本表.xlsx")
