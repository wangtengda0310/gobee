# -*- coding: utf-8 -*-
"""校验 ArenaScoreRewards.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '竞技场积分奖励表|ArenaScoreReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ArenaScoreRewards.xlsx")
    parser.add_argument("path", help="ArenaScoreRewards.xlsx 路径")
