# -*- coding: utf-8 -*-
"""校验 Recharge_映射表.xlsx：通用结构化规则（表结构 A，主键 IdAndroid）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 Recharge_映射表.xlsx")
    parser.add_argument("path", help="Recharge_映射表.xlsx 路径")
