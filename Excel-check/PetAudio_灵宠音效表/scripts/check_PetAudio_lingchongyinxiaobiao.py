# -*- coding: utf-8 -*-
"""校验 PetAudio_灵宠音效表.xlsx：通用结构化规则（表结构 A，主键 ItemCfgId）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PetAudio_灵宠音效表.xlsx")
    parser.add_argument("path", help="PetAudio_灵宠音效表.xlsx 路径")
