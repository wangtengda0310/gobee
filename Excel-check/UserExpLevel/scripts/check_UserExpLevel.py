# -*- coding: utf-8 -*-
"""校验 UserExpLevel.xlsx：通用结构化规则（表结构 A，主键 Level）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '玩家经验等级表|UserExpLevel'
PK_FIELD = 'Level'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 UserExpLevel.xlsx")
    parser.add_argument("path", help="UserExpLevel.xlsx 路径")
