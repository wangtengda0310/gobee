# -*- coding: utf-8 -*-
"""校验 RougeEndlessBattleNode_千里单骑无尽战斗节点.xlsx（表结构 A，主键 BattleNodeId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑无尽战斗|RougeEndlessBattleNode'
PK_FIELD = 'BattleNodeId'
L1_FIELDS = ['BattleNodeName', 'BattleNodeDes', 'SneakName', 'SneakDes']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessBattleNode_千里单骑无尽战斗节点.xlsx")
