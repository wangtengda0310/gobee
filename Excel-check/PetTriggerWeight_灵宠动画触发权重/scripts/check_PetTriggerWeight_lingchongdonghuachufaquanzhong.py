# -*- coding: utf-8 -*-
"""校验 PetTriggerWeight_灵宠动画触发权重.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 5
SHEET_NAME = '灵宠动画触发权重|PetTriggerWeight'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PetTriggerWeight_灵宠动画触发权重.xlsx")
    parser.add_argument("path", help="PetTriggerWeight_灵宠动画触发权重.xlsx 路径")
