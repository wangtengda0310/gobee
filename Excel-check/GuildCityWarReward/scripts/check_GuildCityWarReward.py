# -*- coding: utf-8 -*-
"""校验 GuildCityWarReward.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '势力敌对奖励表|GuildCityWarReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 GuildCityWarReward.xlsx")
    parser.add_argument("path", help="GuildCityWarReward.xlsx 路径")
