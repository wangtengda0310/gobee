# -*- coding: utf-8 -*-
"""校验 CollectionLevel_收藏品阶等级表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '收藏品阶等级表|CollectionLevel'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 CollectionLevel_收藏品阶等级表.xlsx")
    parser.add_argument("path", help="CollectionLevel_收藏品阶等级表.xlsx 路径")
