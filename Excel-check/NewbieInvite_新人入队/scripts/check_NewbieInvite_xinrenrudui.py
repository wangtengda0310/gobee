# -*- coding: utf-8 -*-
"""校验 NewbieInvite_新人入队.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 NewbieInvite_新人入队.xlsx")
    parser.add_argument("path", help="NewbieInvite_新人入队.xlsx 路径")
