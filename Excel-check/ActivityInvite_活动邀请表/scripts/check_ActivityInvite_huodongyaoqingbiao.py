# -*- coding: utf-8 -*-
"""校验 ActivityInvite_活动邀请表.xlsx：通用结构化规则（表结构 A，主键 ActivityId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '活动邀请表|ActivityInvite'
PK_FIELD = 'ActivityId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ActivityInvite_活动邀请表.xlsx")
    parser.add_argument("path", help="ActivityInvite_活动邀请表.xlsx 路径")
