# -*- coding: utf-8 -*-
"""校验 SeasonPass_赛季战令表.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SeasonPass_赛季战令表.xlsx")
    parser.add_argument("path", help="SeasonPass_赛季战令表.xlsx 路径")
