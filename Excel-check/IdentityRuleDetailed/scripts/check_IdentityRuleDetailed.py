# -*- coding: utf-8 -*-
"""校验 IdentityRuleDetailed.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '身份介绍|IdentityRuleDetailed'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 IdentityRuleDetailed.xlsx")
    parser.add_argument("path", help="IdentityRuleDetailed.xlsx 路径")
