# -*- coding: utf-8 -*-
"""校验 PveBaWangZhiLuanStage_八王之乱关卡表.xlsx：通用结构化规则（表结构 A，主键 Id）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 3
SHEET_NAME = '八王之乱关卡表|PveBaWangZhiLuanStage'
PK_FIELD = 'Id'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveBaWangZhiLuanStage_八王之乱关卡表.xlsx")
    parser.add_argument("path", help="PveBaWangZhiLuanStage_八王之乱关卡表.xlsx 路径")
