# -*- coding: utf-8 -*-
"""校验 PveRougeRestNode_千里单骑休息节点配置.xlsx：通用结构化规则（表结构 A，主键 RestNodeId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑休息节点|PveRougeRestNode'
PK_FIELD = 'RestNodeId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeRestNode_千里单骑休息节点配置.xlsx")
    parser.add_argument("path", help="PveRougeRestNode_千里单骑休息节点配置.xlsx 路径")
