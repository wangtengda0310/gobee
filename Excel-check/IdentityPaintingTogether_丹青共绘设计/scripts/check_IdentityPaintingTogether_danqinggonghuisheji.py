# -*- coding: utf-8 -*-
"""校验 IdentityPaintingTogether_丹青共绘设计.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '丹青共绘|IdentityPaintingTogether'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 IdentityPaintingTogether_丹青共绘设计.xlsx")
    parser.add_argument("path", help="IdentityPaintingTogether_丹青共绘设计.xlsx 路径")
