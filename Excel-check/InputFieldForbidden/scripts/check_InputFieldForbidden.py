# -*- coding: utf-8 -*-
"""校验 InputFieldForbidden.xlsx：通用结构化规则（表结构 A，主键 Type）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '输入框禁止表|InputFieldForbidden'
PK_FIELD = 'Type'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 InputFieldForbidden.xlsx")
    parser.add_argument("path", help="InputFieldForbidden.xlsx 路径")
