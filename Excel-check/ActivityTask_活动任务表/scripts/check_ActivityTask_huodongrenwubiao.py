# -*- coding: utf-8 -*-
"""校验 ActivityTask_活动任务表.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ActivityTask_活动任务表.xlsx")
    parser.add_argument("path", help="ActivityTask_活动任务表.xlsx 路径")
