# -*- coding: utf-8 -*-
"""校验 ItemHeroSkin_武将皮肤展示表.xlsx：通用结构化规则（表结构 A，主键 SkinItemId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '武将皮肤展示表|ItemHeroSkin'
PK_FIELD = 'SkinItemId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ItemHeroSkin_武将皮肤展示表.xlsx")
    parser.add_argument("path", help="ItemHeroSkin_武将皮肤展示表.xlsx 路径")
