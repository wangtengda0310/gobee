# -*- coding: utf-8 -*-
"""校验 QYCollection_群英荟萃表.xlsx：通用结构化规则（表结构 A，主键 activityid）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 QYCollection_群英荟萃表.xlsx")
    parser.add_argument("path", help="QYCollection_群英荟萃表.xlsx 路径")
