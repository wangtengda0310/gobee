# -*- coding: utf-8 -*-
"""校验 OpenSysControl_功能开关表.xlsx：通用结构化规则（表结构 A，主键 SysId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '系统功能开关|OpenSysControl'
PK_FIELD = 'SysId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 OpenSysControl_功能开关表.xlsx")
    parser.add_argument("path", help="OpenSysControl_功能开关表.xlsx 路径")
