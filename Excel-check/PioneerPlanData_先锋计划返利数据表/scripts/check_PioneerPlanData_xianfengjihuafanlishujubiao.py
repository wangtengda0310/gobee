# -*- coding: utf-8 -*-
"""校验 PioneerPlanData_先锋计划返利数据表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '先锋计划数据表|PioneerPlanData'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PioneerPlanData_先锋计划返利数据表.xlsx")
    parser.add_argument("path", help="PioneerPlanData_先锋计划返利数据表.xlsx 路径")
