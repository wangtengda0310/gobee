# -*- coding: utf-8 -*-
"""校验 PeakRankReward_巅峰竞技排名奖励.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '巅峰排名奖励表|PeakRankReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PeakRankReward_巅峰竞技排名奖励.xlsx")
    parser.add_argument("path", help="PeakRankReward_巅峰竞技排名奖励.xlsx 路径")
