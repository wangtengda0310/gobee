# -*- coding: utf-8 -*-
"""校验 PveSeatGroup_Pve座位配置.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveSeatGroup_Pve座位配置.xlsx")
    parser.add_argument("path", help="PveSeatGroup_Pve座位配置.xlsx 路径")
