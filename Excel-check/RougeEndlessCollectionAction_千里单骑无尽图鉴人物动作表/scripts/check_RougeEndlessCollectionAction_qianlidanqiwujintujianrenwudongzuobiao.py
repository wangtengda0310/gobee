# -*- coding: utf-8 -*-
"""校验 RougeEndlessCollectionAction_千里单骑无尽图鉴人物动作表.xlsx：通用结构化规则（表结构 A，主键 name）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '图鉴|RougeEndlessCollectionAction'
PK_FIELD = 'name'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessCollectionAction_千里单骑无尽图鉴人物动作表.xlsx")
    parser.add_argument("path", help="RougeEndlessCollectionAction_千里单骑无尽图鉴人物动作表.xlsx 路径")
