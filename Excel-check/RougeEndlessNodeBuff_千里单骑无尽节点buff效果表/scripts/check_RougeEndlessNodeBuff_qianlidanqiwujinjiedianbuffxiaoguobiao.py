# -*- coding: utf-8 -*-
"""校验 RougeEndlessNodeBuff_千里单骑无尽节点buff效果表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽buff效果表|RougeEndlessNodeBuff'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessNodeBuff_千里单骑无尽节点buff效果表.xlsx")
    parser.add_argument("path", help="RougeEndlessNodeBuff_千里单骑无尽节点buff效果表.xlsx 路径")
