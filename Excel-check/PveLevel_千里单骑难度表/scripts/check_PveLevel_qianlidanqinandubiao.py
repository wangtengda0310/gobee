# -*- coding: utf-8 -*-
"""校验 PveLevel_千里单骑难度表.xlsx：通用结构化规则（表结构 A，主键 LevelId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑难度表|PveRougeLevel'
PK_FIELD = 'LevelId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveLevel_千里单骑难度表.xlsx")
    parser.add_argument("path", help="PveLevel_千里单骑难度表.xlsx 路径")
