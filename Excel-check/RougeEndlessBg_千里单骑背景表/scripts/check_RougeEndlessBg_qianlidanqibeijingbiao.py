# -*- coding: utf-8 -*-
"""校验 RougeEndlessBg_千里单骑背景表.xlsx：通用结构化规则（表结构 A，主键 RougeNodeType）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑背景表|RougeEndlessBg'
PK_FIELD = 'RougeNodeType'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessBg_千里单骑背景表.xlsx")
    parser.add_argument("path", help="RougeEndlessBg_千里单骑背景表.xlsx 路径")
