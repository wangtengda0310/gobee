# -*- coding: utf-8 -*-
"""校验 HeroSkinSpine_英雄皮肤Spine.xlsx：通用结构化规则（表结构 A，主键 SkinItemId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '英雄皮肤Spine|HeroSkinSpine'
PK_FIELD = 'SkinItemId'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroSkinSpine_英雄皮肤Spine.xlsx")
    parser.add_argument("path", help="HeroSkinSpine_英雄皮肤Spine.xlsx 路径")
