# -*- coding: utf-8 -*-
"""校验 SeasonPassReward_赛季战令奖励表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 5
SHEET_NAME = '赛季战令奖励表|SeasonPassReward'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 SeasonPassReward_赛季战令奖励表.xlsx")
    parser.add_argument("path", help="SeasonPassReward_赛季战令奖励表.xlsx 路径")
