# -*- coding: utf-8 -*-
"""校验 IdentityDesignCompetition_身份设计大赛.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '身份设计|IdentityDesignCompetition'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 IdentityDesignCompetition_身份设计大赛.xlsx")
    parser.add_argument("path", help="IdentityDesignCompetition_身份设计大赛.xlsx 路径")
