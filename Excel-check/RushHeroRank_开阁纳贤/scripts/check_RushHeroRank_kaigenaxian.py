# -*- coding: utf-8 -*-
"""校验 RushHeroRank_开阁纳贤.xlsx：通用结构化规则（首轮自动生成）。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RushHeroRank_开阁纳贤.xlsx")
    parser.add_argument("path", help="RushHeroRank_开阁纳贤.xlsx 路径")
