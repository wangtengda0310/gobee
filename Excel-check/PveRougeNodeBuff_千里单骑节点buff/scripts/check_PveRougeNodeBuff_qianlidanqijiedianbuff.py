# -*- coding: utf-8 -*-
"""校验 PveRougeNodeBuff_千里单骑节点buff.xlsx（表结构 A，主键 PveNodeBuffId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑节点加成配置|PveRougeNodeBuff'
PK_FIELD = 'PveNodeBuffId'
L1_FIELDS = ['BuffName', 'ReinforceName', 'ReinforceDes', 'DoubleCheckDes']
DISPLAY_FIELD = 'BuffName'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeNodeBuff_千里单骑节点buff.xlsx")
