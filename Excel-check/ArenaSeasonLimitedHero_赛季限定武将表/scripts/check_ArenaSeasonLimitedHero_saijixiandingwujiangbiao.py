# -*- coding: utf-8 -*-
"""校验 ArenaSeasonLimitedHero_赛季限定武将表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '赛季限定武将表|ArenaSeasonLimitedHero'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ArenaSeasonLimitedHero_赛季限定武将表.xlsx")
    parser.add_argument("path", help="ArenaSeasonLimitedHero_赛季限定武将表.xlsx 路径")
