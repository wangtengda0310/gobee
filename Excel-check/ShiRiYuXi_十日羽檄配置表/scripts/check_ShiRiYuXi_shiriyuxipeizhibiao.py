# -*- coding: utf-8 -*-
"""校验 ShiRiYuXi_十日羽檄配置表.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '十日羽檄表|ActivityTenDay'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 ShiRiYuXi_十日羽檄配置表.xlsx")
    parser.add_argument("path", help="ShiRiYuXi_十日羽檄配置表.xlsx 路径")
