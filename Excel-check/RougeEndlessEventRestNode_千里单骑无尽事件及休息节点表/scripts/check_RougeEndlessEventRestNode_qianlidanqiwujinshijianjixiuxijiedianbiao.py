# -*- coding: utf-8 -*-
"""校验 RougeEndlessEventRestNode_千里单骑无尽事件及休息节点表.xlsx：通用结构化规则（表结构 A，主键 EventNodeId）。"""
...
def main() -> int:
    ...
    parser.add_argument("path", help="RougeEndlessEventRestNode_千里单骑无尽事件及休息节点表.xlsx 路径")
