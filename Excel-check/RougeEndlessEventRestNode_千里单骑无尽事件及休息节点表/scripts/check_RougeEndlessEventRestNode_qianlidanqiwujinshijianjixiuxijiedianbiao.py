# -*- coding: utf-8 -*-
"""校验 RougeEndlessEventRestNode_千里单骑无尽事件及休息节点表.xlsx（表结构 A，主键 EventNodeId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '无尽事件节点表|RougeEndlessEventNode'
PK_FIELD = 'EventNodeId'
L1_FIELDS = ['BattleEndNodes', 'EventSectionTitle1', 'EventSectionDesc1', 'EventSectionTitle2', 'EventSectionDesc2', 'EventSectionTitle3', 'EventSectionDesc3', 'EventNodeName', 'EventNodeDes']
DISPLAY_FIELD = 'BattleEndNodes'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 RougeEndlessEventRestNode_千里单骑无尽事件及休息节点表.xlsx")
