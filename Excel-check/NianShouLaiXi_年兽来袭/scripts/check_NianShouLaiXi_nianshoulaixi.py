# -*- coding: utf-8 -*-
"""校验 NianShouLaiXi_年兽来袭.xlsx：通用结构化规则（首轮自动生成）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '年兽来袭配置|NianShouLaiXi'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 NianShouLaiXi_年兽来袭.xlsx")
    parser.add_argument("path", help="NianShouLaiXi_年兽来袭.xlsx 路径")
