# -*- coding: utf-8 -*-
"""校验 PveRougeBattleNode_千里单骑战斗节点配置.xlsx（表结构 A，主键 BattleNodeId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑战斗节点|PveRougeBattleNode'
PK_FIELD = 'BattleNodeId'
L1_FIELDS = ['BattleNodeName', 'BattleNodeDes', 'CompleteName', 'SneakName', 'SneakDes']
DISPLAY_FIELD = 'BattleNodeName'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeBattleNode_千里单骑战斗节点配置.xlsx")
