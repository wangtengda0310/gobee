# -*- coding: utf-8 -*-
"""校验 PveRougeEventNode_千里单骑事件节点配置.xlsx：通用结构化规则（表结构 A，主键 EventNodeId）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '千里单骑事件节点|PveRougeEventNode'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 PveRougeEventNode_千里单骑事件节点配置.xlsx")
    parser.add_argument("path", help="PveRougeEventNode_千里单骑事件节点配置.xlsx 路径")
