# -*- coding: utf-8 -*-
"""校验 ArenaSeason.xlsx（表结构 A，主键 Id）。"""
...
PK_FIELD = 'Id'
L1_FIELDS = ['SeasonStartTime', 'SeasonEndTime', 'SpRewardText', 'SeasonName', 'ModeName', 'SpineName', 'BGName', 'FontBGName', 'SeasonTips']
DISPLAY_FIELD = 'SeasonStartTime'
ID_TYPE = 'int'
STRUCT_KIND = 'A'
