# -*- coding: utf-8 -*-
"""校验 HeroExpansionPack_武将扩展包配置表.xlsx：通用结构化规则（表结构 A，主键 ExpansionPackType）。"""
...
HEADER_ROW = 2
DATA_START_ROW = 4
SHEET_NAME = '武将扩展包|HeroExpansionPack'
PK_FIELD = 'ExpansionPackType'
...
def main() -> int:
    parser = argparse.ArgumentParser(description="校验 HeroExpansionPack_武将扩展包配置表.xlsx")
    parser.add_argument("path", help="HeroExpansionPack_武将扩展包配置表.xlsx 路径")
