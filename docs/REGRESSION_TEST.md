...
| ZIP 格式 | ✅ | ✅ | ✅ | ✅ |
| DIR 格式 | ✅ | ✅ | ⚠️ | ⚠️ |
| Redis (场景1,2,3) | 🔶 待实现 | 🔶 待实现 | 🔶 待实现 | 🔶 待实现 |

**说明**:
- ✅ 已完成
- ⚠️ 部分完成
- 🔶 计划中 (详见 `REGRESSION_TEST_REDIS.md`)

### Redis 测试覆盖

详见: **[Redis 支持回归测试文档](REGRESSION_TEST_REDIS.md)**

| 场景 | 测试用例组 | 测试用例数 | 优先级 | 状态 |
|------|-----------|-----------|--------|------|
| 场景1: Redis 中转 | MR101-MR103, V101-V105 | 15+ | P1 | 🔶 待实现 |
| 场景2: 业务数据 | RS01-RS04, RH01-RH03, RZ01-RZ03 | 30+ | **P0** | 🔶 待实现 |
| 场景3: 降低门槛 | UX101-UX104, UX201-UX204, UX301-UX304 | 12+ | **P0** | 🔶 待实现 |
