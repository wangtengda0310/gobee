...
// GetHeroSkinSpineImgMap
// skinIdSpineAnimAudioMap 皮肤道具ID=>动画音效枚举
// skinIdKillAudioMap 皮肤道具ID=>击杀动画音效
func GetHeroSkinSpineImgMap(sheetMap map[string]*excelize.File) (skinIdSpineAnimAudioMap map[int][]string, skinIdKillAudioMap map[int]string, err error) {
